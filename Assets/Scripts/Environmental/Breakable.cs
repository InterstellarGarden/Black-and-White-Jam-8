...
public class Breakable : MonoBehaviour
{
    ...
    public void Break()
    {
        ...
        if (!broken.activeSelf)
        {
            ...
            broken.transform.position = not_broken.transform.position;
            broken.transform.rotation = not_broken.transform.rotation;

            //Enable the broken object
            broken.SetActive(true);

            //Give every boken piece the same velocity as the unbroken object in case the object was falling while being broken
