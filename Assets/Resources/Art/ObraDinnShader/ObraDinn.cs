...
public class ObraDinn : MonoBehaviour
{
    ...
    void OnRenderImage(RenderTexture src, RenderTexture dst) {
		...
		RenderTexture large = RenderTexture.GetTemporary(Screen.width, Screen.height, 0, RenderTextureFormat.ARGB32);
		RenderTexture main = RenderTexture.GetTemporary(Screen.width, Screen.height, 0, RenderTextureFormat.ARGB32);
