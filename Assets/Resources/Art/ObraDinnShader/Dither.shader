        ...
        float2 edge(float2 uv, float2 delta)
{
        ...
        float4 frag(v2f i) : SV_Target
        {
            ...
            //float ditherLum = (col.a < 0.5) ? cubeProject(_Dither, _Dither_TexelSize.xy, dir) : 0;
            ...
            lum = (edgeData.y <= _Threshold) ? lum : ((edgeData.x < 0.5f) ? 1.0f : 0.0f);
